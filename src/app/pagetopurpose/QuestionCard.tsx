            ...
            case 'textarea':
                 return (
                    <Textarea 
                        ...
                        {...commonProps} 
                        rows={5} 
                        className="bg-transparent border border-border rounded-lg text-lg p-4 text-foreground"
                    />
                )
            case 'radio':
                return (
                    ...
                    >
                        {question.options?.map(option => {
                            ...
                            >
                                ...
                                <span className="font-normal flex-grow text-foreground">{option.label}</span>
                            </Label>
                        )})}
                    </RadioGroup>
                );
    ...
    return (
        ...
        >
            <div className="p-4 sm:p-8 rounded-lg w-full">
                {question.section && <p className="text-sm font-semibold text-primary mb-2 uppercase tracking-wider">{question.section}</p>}
