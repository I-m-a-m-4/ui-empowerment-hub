  ...
  questions.forEach(q => {
    ...
    switch(q.type) {
        ...
        case 'tel':
            ...
            break;
        case 'number':
            schema = z.string().refine(val => !isNaN(parseInt(val, 10)) && parseInt(val, 10) >= 1 && parseInt(val, 10) <= 10, { message: "Please enter a number between 1 and 10." });
            break;
        default:
            schema = z.string();
            break;
        ...
        <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
            <div className="w-full text-center p-8 bg-background rounded-lg shadow-lg relative">
                ...
                <p className="text-muted-foreground mb-8">
                    Thank you for joining Page to Purpose™. We're excited to have you with us!
                </p>
                 <Button asChild>
                    <Link href="/">
